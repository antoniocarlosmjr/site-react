...
/**
 * Adiciona somente os íncones sólidos.
 */
library.add(fas);

/**
 * Homepage do site de doação.
 * @returns {JSX.Element}
 * @constructor
 */
    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Site de doação de insumos"/>
...
/**
 * Realiza a requisição para API e retornar os dados da home.
 * @returns {Promise<{propos: {data: any}}>}
 */
